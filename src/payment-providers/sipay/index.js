...
function getToken() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, node_fetch_1["default"](SIPAY.host + "/ccpayment/api/token", {
                        method: 'POST',
...
function getPosList(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, node_fetch_1["default"](SIPAY.host + "/ccpayment/api/getpos", {
                        method: 'POST',
                        body: JSON.stringify({
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        orderId = nanoid_1.nanoid(8).toLowerCase();
